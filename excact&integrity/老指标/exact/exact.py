...
class Test:
    ...
    def stb_pm_vmos(self, file_in, file_out):
        ...
        # 卡顿总次数<=900
        dict1['STB-PM-VMOS-016'] = file_chunk.loc[file_chunk[16] > 900].count1.count()
        # 卡顿超过10秒的总次数<=900
        dict1['STB-PM-VMOS-017'] = file_chunk.loc[file_chunk[17] > 900].count1.count()
        # 0<收视vmos<=5
        dict1['STB-PM-VMOS-018'] = file_chunk.loc[(file_chunk[18] > 5) | (file_chunk[18] == 0)].count1.count()
        # 卡顿总时长<=收视总时长
        ...
        xx = file_chunk.loc[
            ...
            (file_chunk[14] > 900) | (file_chunk[15] > 900) | (file_chunk[16] > 900) | (file_chunk[17] > 900) | (
                        file_chunk[18] > 5) | (file_chunk[18] <= 0),
